...
/**
 * Title: Site Identity
 * Slug: patterns-store-front/site-identity
 * Categories: posts
...
<div class="wp-block-group"><!-- wp:site-logo {"width":40,"shouldSyncIcon":true} /-->
	...
	<!-- wp:group {"style":{"spacing":{"blockGap":"0px"},"layout":{"selfStretch":"fixed","flexSize":"190px"}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"vertical"}} -->
