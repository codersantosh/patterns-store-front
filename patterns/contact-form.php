...
<p class="has-text-align-left has-default-color has-primary-background-color has-text-color has-background has-link-color" style="margin-bottom:0px;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px"><?php esc_html_e( 'Let’s talk', 'patterns-store-front' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-align-left has-accent-color has-text-color" style="margin-top:5px;margin-bottom:40px;line-height:1.7"><?php esc_html_e( 'We’d love to hear from you! Please fill out the form or reach us through the following methods.', 'patterns-store-front' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-accent-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:10px"><a href="#"><?php esc_html_e( '(629) 555-0129', 'patterns-store-front' ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0px","bottom":"10px"}},"elements":{"link":{"color":{"text":"var:preset|color|accent"},":hover":{"color":{"text":"var:preset|color|primary"}}}}},"textColor":"accent"} -->
<p class="has-text-align-left has-accent-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:10px"><a href="<?php echo esc_url( 'mailto:info@example.com' ); ?>"><?php esc_html_e( 'info@example.com', 'patterns-store-front' ); ?></a></p>
<!-- /wp:paragraph -->
