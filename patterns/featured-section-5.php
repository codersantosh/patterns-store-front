...
<div class="wp-block-group" style="border-radius:5px;margin-top:-130px">
	...
	<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/featured-img-2.jpg" alt="<?php esc_attr_e( 'Feature image 2', 'patterns-store-front' ); ?>" style="border-radius:5px;box-shadow:var(--wp--preset--shadow--deep)"/></figure>
	<!-- /wp:image --></div>
	<!-- /wp:group -->
	...
	<p class="has-text-align-center has-x-large-font-size" style="margin-bottom:5px;font-style:normal;font-weight:800"><?php esc_html_e( '16K+', 'patterns-store-front' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<h2 class="wp-block-heading has-base-color has-text-color " style="margin-bottom:20px;font-size:36px;font-style:normal;font-weight:800;line-height:1"><?php esc_html_e( 'We Are Dedicated to Shape Perfect Solutions', 'patterns-store-front' ); ?></h2>
	<!-- /wp:heading -->
