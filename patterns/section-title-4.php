...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"44px","fontStyle":"normal","fontWeight":"700"},"spacing":{"margin":{"bottom":"10px"}}},"textColor":"default"} -->
<h2 class="wp-block-heading has-text-align-center has-default-color has-text-color" style="margin-bottom:10px;font-size:44px;font-style:normal;font-weight:700"><?php esc_html_e( 'Try it now !', 'patterns-store-front' ); ?></h2>
<!-- /wp:heading -->
