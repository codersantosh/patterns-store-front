...
<!-- wp:paragraph {"placeholder":"<?php esc_attr_e( 'Relation', 'patterns-store-front' ); ?>","metadata":{"bindings":{"content":{"source":"patterns-store/pattern-data","args":{"key":"patterns_store_pattern_relation"}}}}} -->
<p></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
