...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color" style="margin-bottom:20px;font-size:75px;font-style:normal;font-weight:800;line-height:0.9"><?php esc_html_e( 'Amazing services to build busines growth', 'patterns-store-front' ); ?></h1>
<!-- /wp:heading -->
