...
global $current_user;
?>
<div id='patternswp-psf-review-notice' class="notice updated patternswp-psf-review-notice at-p at-pos">
	<button class="patternswp-psf-rn-permanent-close notice-dismiss at-flx at-al-itm-ctr">
	...
	<div class="links">
		...
		<button class="patternswp-psf-rn-temporary-close patternswp-psf-btn-secondary button-primary at-inl-flx at-al-itm-ctr at-gap">
			<span class="dashicons dashicons-calendar"></span>
			<span><?php esc_html_e( 'Maybe later', 'patterns-store-front' ); ?></span>
		</button>

		<button class="patternswp-psf-rn-permanent-close patternswp-psf-btn-default button-primary at-inl-flx at-al-itm-ctr at-gap">
