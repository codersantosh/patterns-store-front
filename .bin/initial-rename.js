...
const options = {
    ...
    to: [
        'patterns-store-front' /******************** replace with your theme details */,
        'patterns_store_front',
        'PATTERNS_STORE_THEME',
        'PATTERNS-STORE-THEME',
        'Patterns-Store-Front',
        'Patterns_Store_Front',
        'PatternsStoreFront',
        'Patterns Store Front',
        'patternswp-psf', //can use brandname as prefix
    ],
    verbose: true,
    dry: false,
};
